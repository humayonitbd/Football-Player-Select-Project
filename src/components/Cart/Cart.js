        ...
        <div>
            ...
            <div className='mt-5'>
                ...
                <ul className='flex justify-between px-4'>
                    <li className='bg-purple-50 p-3 rounded-full secondsSec'><span onClick={(e) => breackHandler(e)}>15</span>s</li>
                    <li className='bg-purple-50 p-3 rounded-full'><span onClick={(e) => breackHandler(e)} className='option'>25</span>s</li>
                    <li className='bg-purple-50 p-3 rounded-full'><span onClick={(e) => breackHandler(e)} className='option'>35</span>s</li>
                    <li className='bg-purple-50 p-3 rounded-full'><span onClick={(e) => breackHandler(e)} className='option'>10</span>s</li>
                </ul>
            </div>
            <div className='mt-8'>
